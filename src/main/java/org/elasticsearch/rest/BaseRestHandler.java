...
public abstract class BaseRestHandler extends AbstractComponent implements RestHandler {
    ...
    protected BaseRestHandler(Settings settings) {
        super(settings);
        System.out.println("org.elasticsearch.rest_BaseRestHandler_BaseRestHandler(Settings settings)");
    }

    @Override
    public final void handleRequest(RestRequest request, RestChannel channel, NodeClient client) throws Exception {
        // prepare the request for execution; has the side effect of touching the request parameters
        System.out.println("org.elasticsearch.rest_BaseRestHandler_handleRequest(RestRequest request, RestChannel channel, NodeClient client)");
        System.out.println(request);
        System.out.println(request.param("source"));
        System.out.println(request.consumedParams());
