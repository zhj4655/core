...
public abstract class RestRequest implements ToXContent.Params {
    ...
    public RestRequest(NamedXContentRegistry xContentRegistry, String uri, Map<String, List<String>> headers) {
        ...
        System.out.println("org.elasticsearch.rest_RestRequest_RestRequest(NamedXContentRegistry xContentRegistry, String uri, Map<String, List<String>> headers)");
        //这里的uri输出的是请求的不带参数的部分，例如输出 /logstash-2017.06.07/_search?pretty 这部分
    ...
    public RestRequest(NamedXContentRegistry xContentRegistry, Map<String, String> params, String path, Map<String, List<String>> headers) {
        ...
        final List<String> contentType = getAllHeaderValues("Content-Type");
        final XContentType xContentType = parseContentType(contentType);
        System.out.println("org.elasticsearch.rest_RestRequest_RestRequest(NamedXContentRegistry xContentRegistry, Map<String, String> params, String path, Map<String, List<String>> headers)");
    ...
    public final String header(String name) {
        System.out.println("org.elasticsearch.rest_RestRequest_header(String name)");
        System.out.println("header函数的参数name:"+name);
    ...
    public final String param(String key) {
        System.out.println("param(String key) key="+key);
    ...
    public final String param(String key, String defaultValue) {
        System.out.println("param(String key, String defaultValue) key="+key);
        consumedParams.add(key);
        String value = params.get(key);
        System.out.println("param(String key, String defaultValue) value="+value);
        if (value == null) {
            return defaultValue;
        }
        return value;
    ...
    List<String> unconsumedParams() {
        System.out.println("org.elasticsearch.rest_RestRequest_unconsumedParams()");
        System.out.println(params.keySet().stream().filter(p -> !consumedParams.contains(p)).collect(Collectors.toList()));
        return params
            .keySet()
            .stream()
    ...
    public float paramAsFloat(String key, float defaultValue) {
        System.out.println("org.elasticsearch.rest_RestRequest_paramAsFloat(String key, float defaultValue)");
    ...
    public int paramAsInt(String key, int defaultValue) {
        System.out.println("org.elasticsearch.rest_RestRequest_paramAsInt(String key, int defaultValue)");
        String sValue = param(key);
        System.out.println("key="+key);
        System.out.println("sValue="+sValue);
        if (sValue == null) {
    ...
    public long paramAsLong(String key, long defaultValue) {
        System.out.println("org.elasticsearch.rest_RestRequest_paramAsLong(String key, long defaultValue)");
        String sValue = param(key);
        System.out.println("key="+key);
        System.out.println("sValue="+sValue);
        if (sValue == null) {
    ...
    public String[] paramAsStringArrayOrEmptyIfAll(String key) {
        System.out.println("org.elasticsearch.rest_RestRequest_paramAsStringArrayOrEmptyIfAll(String key)");
    ...
    public final XContentParser contentParser() throws IOException {
        System.out.println("org.elasticsearch.rest_RestRequest_contentParser()");
    ...
    public final void applyContentParser(CheckedConsumer<XContentParser, IOException> applyParser) throws IOException {
        System.out.println("org.elasticsearch.rest_RestRequest_applyContentParser(CheckedConsumer<XContentParser, IOException> applyParser)");
        if (hasContent()) {
    ...
    public final XContentParser contentOrSourceParamParser() throws IOException {
        System.out.println("org.elasticsearch.rest_RestRequest_contentOrSourceParamParser()");
    ...
    public final void withContentOrSourceParamParserOrNull(CheckedConsumer<XContentParser, IOException> withParser) throws IOException {
        System.out.println("org.elasticsearch.rest_RestRequest_withContentOrSourceParamParserOrNull(CheckedConsumer<XContentParser, IOException>");
        Tuple<XContentType, BytesReference> tuple = contentOrSourceParam();
        BytesReference content = tuple.v2();
    ...
    public final Tuple<XContentType, BytesReference> contentOrSourceParam() {
        System.out.println("org.elasticsearch.rest_RestRequest_contentOrSourceParam()");
        if (hasContent()) {
    ...
    private static XContentType parseContentType(List<String> header) {
        System.out.println("org.elasticsearch.rest_RestRequest_parseContentType(List<String> header)");
        ...
        //输出语句
        System.out.println("parseContentType(List<String> header)函数中rawContentType:"+rawContentType);
        
        final String[] elements = rawContentType.split("[ \t]*;");
        //输出语句
        for (String string : elements) {
            System.out.println("parseContentType(List<String> header)函数中string:"+string);
        }
