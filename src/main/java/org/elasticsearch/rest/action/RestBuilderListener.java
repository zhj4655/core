...
public abstract class RestBuilderListener<Response> extends RestResponseListener<Response> {
    ...
    public RestBuilderListener(RestChannel channel) {
        super(channel);
        System.out.println("org.elasticsearch.rest.action_RestBuilderListener_RestBuilderListener(RestChannel channel)");
    }

    @Override
    public final RestResponse buildResponse(Response response) throws Exception {
        System.out.println("org.elasticsearch.rest.action_RestBuilderListener_buildResponse(Response response)");
    ...
    boolean assertBuilderClosed(XContentBuilder xContentBuilder) {
        System.out.println("org.elasticsearch.rest.action_RestBuilderListener_assertBuilderClosed(XContentBuilder xContentBuilder)");
