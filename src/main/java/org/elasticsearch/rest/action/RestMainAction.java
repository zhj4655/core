...
public class RestMainAction extends BaseRestHandler {
    public RestMainAction(Settings settings, RestController controller) {
        super(settings);
        System.out.println("org.elasticsearch.rest.action_RestMainAction_RestMainAction(Settings settings, RestController controller)");
    ...
    public RestChannelConsumer prepareRequest(final RestRequest request, final NodeClient client) throws IOException {
        System.out.println("org.elasticsearch.rest.action_RestMainAction_prepareRequest(final RestRequest request, final NodeClient client)");
