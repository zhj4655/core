...
public class AcknowledgedRestListener<T extends AcknowledgedResponse> extends RestBuilderListener<T> {
    ...
    public AcknowledgedRestListener(RestChannel channel) {
        super(channel);
        System.out.println("org.elasticsearch.rest.action_AcknowledgedRestListener_AcknowledgedRestListener(RestChannel channel)");
    }

    @Override
    public RestResponse buildResponse(T response, XContentBuilder builder) throws Exception {
        System.out.println("org.elasticsearch.rest.action_AcknowledgedRestListener_buildResponse(T response, XContentBuilder builder)");
        builder.startObject()
