...
public class RestStatusToXContentListener<Response extends StatusToXContentObject> extends RestToXContentListener<Response> {
    ...
    public RestStatusToXContentListener(RestChannel channel) {
        this(channel, r -> {
            System.out.println("org.elasticsearch.rest.action——RestStatusToXContentListener_RestStatusToXContentListener(RestChannel channel)");
    ...
    public RestStatusToXContentListener(RestChannel channel, Function<Response, String> extractLocation) {
        super(channel);
        System.out.println("org.elasticsearch.rest.action——RestStatusToXContentListener_RestStatusToXContentListener(RestChannel channel, Function<Response, String> extractLocation)");
        this.extractLocation = extractLocation;
    }

    @Override
    public RestResponse buildResponse(Response response, XContentBuilder builder) throws Exception {
        System.out.println("org.elasticsearch.rest.action——RestStatusToXContentListener_buildResponse(Response response, XContentBuilder builder)");
