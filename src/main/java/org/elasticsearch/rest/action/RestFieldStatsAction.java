...
public class RestFieldStatsAction extends BaseRestHandler {
    public RestFieldStatsAction(Settings settings, RestController controller) {
        super(settings);
        System.out.println("org.elasticsearch.rest.action_RestFieldStatsAction_RestFieldStatsAction(Settings settings, RestController controller)");
    ...
    static String deprecationMessage() {
        System.out.println("org.elasticsearch.rest.action_RestFieldStatsAction_deprecationMessage()");
    ...
    public RestChannelConsumer prepareRequest(final RestRequest request,
        ...
        System.out.println("org.elasticsearch.rest.action_RestFieldStatsAction_ prepareRequest(final RestRequest request, final NodeClient client)");
