...
public class RestToXContentListener<Response extends ToXContentObject> extends RestResponseListener<Response> {
    ...
    public RestToXContentListener(RestChannel channel) {
        super(channel);
        System.out.println("org.elasticsearch.rest.action_RestToXContentListener_RestToXContentListener(RestChannel channel)");
    }

    @Override
    public final RestResponse buildResponse(Response response) throws Exception {
        System.out.println("org.elasticsearch.rest.action_RestToXContentListener_buildResponse(Response response)");
        return buildResponse(response, channel.newBuilder());
    }

    public RestResponse buildResponse(Response response, XContentBuilder builder) throws Exception {
        System.out.println("org.elasticsearch.rest.action_RestToXContentListener_buildResponse(Response response, XContentBuilder builder)");
    ...
    protected RestStatus getStatus(Response response) {
        System.out.println("org.elasticsearch.rest.action_RestToXContentListener_getStatus(Response response)");
