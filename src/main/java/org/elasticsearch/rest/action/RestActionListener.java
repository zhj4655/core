...
public abstract class RestActionListener<Response> implements ActionListener<Response> {
    ...
    public final void onResponse(Response response) {
        System.out.println("org.elasticsearch.rest.action_RestActionListener_onResponse(Response response)");
    ...
    public final void onFailure(Exception e) {
        System.out.println("org.elasticsearch.rest.action_RestActionListener_onFailure(Exception e)");
