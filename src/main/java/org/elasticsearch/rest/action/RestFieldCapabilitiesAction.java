...
public class RestFieldCapabilitiesAction extends BaseRestHandler {
    public RestFieldCapabilitiesAction(Settings settings, RestController controller) {
        super(settings);
        System.out.println("org.elasticsearch.rest.action_RestFieldCapabilitiesAction_RestFieldCapabilitiesAction(Settings settings, RestController controller)");
    ...
    public RestChannelConsumer prepareRequest(final RestRequest request,
        ...
        System.out.println("org.elasticsearch.rest.action_RestFieldCapabilitiesAction_prepareRequest(final RestRequest request, final NodeClient client)");
