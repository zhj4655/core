...
public abstract class RestResponseListener<Response> extends RestActionListener<Response> {
    ...
    protected RestResponseListener(RestChannel channel) {
        super(channel);
        System.out.println("org.elasticsearch.rest.action_RestResponseListener_RestResponseListener(RestChannel channel)");
    }

    @Override
    protected final void processResponse(Response response) throws Exception {
        System.out.println("org.elasticsearch.rest.action_RestResponseListener_processResponse(Response response)");
