...
public class RestActions {
    ...
    public static long parseVersion(RestRequest request) {
        System.out.println("org.elasticsearch.rest.action_RestActions_parseVersion(RestRequest request)");
    ...
    public static long parseVersion(RestRequest request, long defaultVersion) {
        System.out.println("org.elasticsearch.rest.action_RestActions_parseVersion(RestRequest request, long defaultVersion)");
    ...
    public static void buildBroadcastShardsHeader(XContentBuilder builder, Params params, BroadcastResponse response) throws IOException {
        System.out.println("org.elasticsearch.rest.action_RestActions_buildBroadcastShardsHeader(XContentBuilder builder, Params params, BroadcastResponse response) ");
    ...
    public static void buildBroadcastShardsHeader(XContentBuilder builder, Params params,
        ...
        System.out.println("org.elasticsearch.rest.action_RestActions_ buildBroadcastShardsHeader(XContentBuilder builder, Params params, int total, int successful, int failed, ShardOperationFailedException[] shardFailures)");
    ...
    public static <NodeResponse extends BaseNodeResponse> void buildNodesHeader(final XContentBuilder builder, final Params params,
            ...
            throws IOException {
        System.out.println("org.elasticsearch.rest.action_RestActions_buildNodesHeader(final XContentBuilder builder, final Params params, final BaseNodesResponse<NodeResponse> response)"+params);
        //这里的成功 失败应该指的是集群连接的节点的成功或失败数量
    ...
    public static void buildNodesHeader(final XContentBuilder builder, final Params params,
        ...
        System.out.println("org.elasticsearch.rest.action_RestActions_ buildNodesHeader(final XContentBuilder builder, final Params params, final int total, final int successful, final int failed, final List<FailedNodeException> failures)");
    ...
    public static <NodesResponse extends BaseNodesResponse & ToXContent> BytesRestResponse nodesResponse(final XContentBuilder builder,
            ...
            throws IOException {
        System.out.println("org.elasticsearch.rest.action_RestActions_  nodesResponse(final XContentBuilder builder, final Params params, final NodesResponse response)");
    ...
    public static QueryBuilder urlParamsToQueryBuilder(RestRequest request) {
        System.out.println("org.elasticsearch.rest.action_RestActions_ urlParamsToQueryBuilder(RestRequest request)");
    ...
    public static QueryBuilder getQueryContent(XContentParser requestParser) {
        System.out.println("org.elasticsearch.rest.action_RestActions_getQueryContent(XContentParser requestParser)");
