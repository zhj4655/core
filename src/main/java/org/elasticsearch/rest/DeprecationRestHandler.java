...
public class DeprecationRestHandler implements RestHandler {
    ...
    public DeprecationRestHandler(RestHandler handler, String deprecationMessage, DeprecationLogger deprecationLogger) {
        ...
        System.out.println("org.elasticsearch.rest_DeprecationRestHandler_DeprecationRestHandler(RestHandler handler, String deprecationMessage, DeprecationLogger deprecationLogger)");
    }
    ...
    public void handleRequest(RestRequest request, RestChannel channel, NodeClient client) throws Exception {
        System.out.println("org.elasticsearch.rest_DeprecationRestHandler_handleRequest(RestRequest request, RestChannel channel, NodeClient client)");
    ...
    public static boolean validHeaderValue(String value) {
        System.out.println("org.elasticsearch.rest_DeprecationRestHandler_validHeaderValue(String value)");
    ...
    public static String requireValidHeader(String value) {
        System.out.println("org.elasticsearch.rest_DeprecationRestHandler_requireValidHeader(String value)");
