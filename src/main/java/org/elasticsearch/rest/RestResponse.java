...
public abstract class RestResponse {
    ...
    public void copyHeaders(ElasticsearchException ex) {
        System.out.println("org.elasticsearch.rest_RestResponse_copyHeaders(ElasticsearchException ex)");
    ...
    public void addHeader(String name, String value) {
        System.out.println("org.elasticsearch.rest_RestResponse_addHeader(String name, String value)");
        if (customHeaders == null) {
