...
public class RestController extends AbstractComponent implements HttpServerTransport.Dispatcher {
    ...
    public RestController(Settings settings, Set<String> headersToCopy, UnaryOperator<RestHandler> handlerWrapper,
        ...
        System.out.println("org.elasticsearch.rest_RestController_RestController(Settings settings, Set<String> headersToCopy, UnaryOperator<RestHandler> handlerWrapper, NodeClient client, CircuitBreakerService circuitBreakerService)");
    }
    ...
    public void registerAsDeprecatedHandler(RestRequest.Method method, String path, RestHandler handler,
        ...
        System.out.println("org.elasticsearch.rest_RestController_registerAsDeprecatedHandler(RestRequest.Method method, String path, RestHandler handler, String deprecationMessage, DeprecationLogger logger)");
    ...
    public void registerWithDeprecatedHandler(RestRequest.Method method, String path, RestHandler handler,
        ...
        System.out.println("org.elasticsearch.rest_RestController_registerWithDeprecatedHandler(RestRequest.Method method, String path, RestHandler handler, RestRequest.Method deprecatedMethod, String deprecatedPath, DeprecationLogger logger) ");
    ...
    public void registerHandler(RestRequest.Method method, String path, RestHandler handler) {
        System.out.println("org.elasticsearch.rest_RestController_registerHandler(RestRequest.Method method, String path, RestHandler handler)__注册 GET, {index}/{type}/_search");
    ...
    public boolean canTripCircuitBreaker(RestRequest request) {
        System.out.println("org.elasticsearch.rest_RestController_canTripCircuitBreaker(RestRequest request)");
    ...
    public void dispatchRequest(RestRequest request, RestChannel channel, ThreadContext threadContext) {
        System.out.println("org.elasticsearch.rest_RestController_dispatchRequest(RestRequest request, RestChannel channel, ThreadContext threadContext)");
        System.out.println(request);
        if (request.rawPath().equals("/favicon.ico")) {
            System.out.println("request.rawPath().equals(favicon.ico)");
    ...
    private boolean hasContentTypeOrCanAutoDetect(final RestRequest restRequest, final RestHandler restHandler) {
        System.out.println("org.elasticsearch.rest_RestController_hasContentTypeOrCanAutoDetect(final RestRequest restRequest, final RestHandler restHandler)");
    ...
    private boolean autoDetectXContentType(RestRequest restRequest) {
        System.out.println("org.elasticsearch.rest_RestController_autoDetectXContentType(RestRequest restRequest)");
    ...
    private void sendContentTypeErrorMessage(RestRequest restRequest, RestChannel channel) throws IOException {
        System.out.println("org.elasticsearch.rest_RestController_sendContentTypeErrorMessage(RestRequest restRequest, RestChannel channel)");
    ...
    boolean checkRequestParameters(final RestRequest request, final RestChannel channel) {
        ...
        System.out.println("org.elasticsearch.rest_RestController_checkRequestParameters(final RestRequest request, final RestChannel channel)");
        System.out.println(request);
    ...
    private RestHandler getHandler(RestRequest request) {
        System.out.println("org.elasticsearch.rest_RestController_getHandler(RestRequest request)");
        System.out.println("getHandler(RestRequest request)函数的request值为:"+request);
        String path = getPath(request);
        System.out.println("getHandler(RestRequest request)函数的path值为"+path);
        System.out.println("getHandler(RestRequest request)函数的request.method()值为:"+request.method());
       
        PathTrie<RestHandler> handlers = getHandlersForMethod(request.method());
       
        System.out.println("getHandler(RestRequest request)函数的request.params()值为："+request.params());
        if (handlers != null) {
    ...
    private PathTrie<RestHandler> getHandlersForMethod(RestRequest.Method method) {
        System.out.println("org.elasticsearch.rest_RestController_getHandlersForMethod(RestRequest.Method method) ");
    ...
    private String getPath(RestRequest request) {
        ...
        System.out.println("org.elasticsearch.rest_RestController_getPath(RestRequest request)");
        System.out.println("getPath(RestRequest request)的request.rawPath()值为:"+request.rawPath());
        return request.rawPath();
    }

    void handleFavicon(RestRequest request, RestChannel channel) {
        System.out.println("org.elasticsearch.rest_RestController_handleFavicon(RestRequest request, RestChannel channel) ");
    ...
    private static final class ResourceHandlingHttpChannel implements RestChannel {
        ...
        ResourceHandlingHttpChannel(RestChannel delegate, CircuitBreakerService circuitBreakerService, int contentLength) {
            ...
            System.out.println("org.elasticsearch.rest_RestController_ ResourceHandlingHttpChannel(RestChannel delegate, CircuitBreakerService circuitBreakerService, int contentLength)");
        }
