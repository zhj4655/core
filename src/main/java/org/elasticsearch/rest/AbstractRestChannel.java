...
public abstract class AbstractRestChannel implements RestChannel {
    ...
    protected AbstractRestChannel(RestRequest request, boolean detailedErrorsEnabled) {
        ...
        System.out.println("org.elasticsearch.rest_AbstractRestChannel_AbstractRestChannel(RestRequest request, boolean detailedErrorsEnabled)");
        System.out.println("AbstractRestChannel(RestRequest request, boolean detailedErrorsEnabled)函数初始化的request为"+request);
    }

    @Override
    public XContentBuilder newBuilder() throws IOException {
        System.out.println("org.elasticsearch.rest_AbstractRestChannel_newBuilder()");
    ...
    public XContentBuilder newErrorBuilder() throws IOException {
        ...
        System.out.println("org.elasticsearch.rest_AbstractRestChannel_newErrorBuilder()");
    ...
    public XContentBuilder newBuilder(@Nullable XContentType requestContentType, boolean useFiltering) throws IOException {
        ...
        System.out.println("org.elasticsearch.rest_AbstractRestChannel_newBuilder(@Nullable XContentType requestContentType, boolean useFiltering)");
