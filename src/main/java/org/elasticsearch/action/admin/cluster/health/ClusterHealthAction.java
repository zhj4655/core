...
public class ClusterHealthAction extends Action<ClusterHealthRequest, ClusterHealthResponse, ClusterHealthRequestBuilder> {
    ...
    private ClusterHealthAction() {
        super(NAME);
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthAction.ClusterHealthAction()");
    }

    @Override
    public ClusterHealthResponse newResponse() {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthAction.newResponse()");
        return new ClusterHealthResponse();
    }

    @Override
    public ClusterHealthRequestBuilder newRequestBuilder(ElasticsearchClient client) {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthAction.newRequestBuilder(ElasticsearchClient client)");
