...
public class ClusterHealthRequestBuilder extends MasterNodeReadOperationRequestBuilder<ClusterHealthRequest, ClusterHealthResponse, ClusterHealthRequestBuilder> {
    ...
    public ClusterHealthRequestBuilder(ElasticsearchClient client, ClusterHealthAction action) {
        ...
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthRequestBuilder_ClusterHealthRequestBuilder(ElasticsearchClient client, ClusterHealthAction action)");
    }

    public ClusterHealthRequestBuilder setIndices(String... indices) {
        request.indices(indices);
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthRequestBuilder_setIndices(String... indices)");
        return this;
    }

    public ClusterHealthRequestBuilder setTimeout(TimeValue timeout) {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthRequestBuilder_setTimeout(TimeValue timeout)");
        request.timeout(timeout);
        return this;
    }

    public ClusterHealthRequestBuilder setTimeout(String timeout) {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthRequestBuilder_setTimeout(String timeout)");
        request.timeout(timeout);
        return this;
    }

    public ClusterHealthRequestBuilder setWaitForStatus(ClusterHealthStatus waitForStatus) {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthRequestBuilder_setWaitForStatus(ClusterHealthStatus waitForStatus)");
        request.waitForStatus(waitForStatus);
        return this;
    }

    public ClusterHealthRequestBuilder setWaitForGreenStatus() {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthRequestBuilder_setWaitForGreenStatus()");
        request.waitForGreenStatus();
        return this;
    }

    public ClusterHealthRequestBuilder setWaitForYellowStatus() {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthRequestBuilder_setWaitForYellowStatus()");
    ...
    public ClusterHealthRequestBuilder setWaitForNoRelocatingShards(boolean waitForRelocatingShards) {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthRequestBuilder_setWaitForNoRelocatingShards(boolean waitForRelocatingShards)");
    ...
    public ClusterHealthRequestBuilder setWaitForActiveShards(ActiveShardCount waitForActiveShards) {
        ...
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthRequestBuilder_setWaitForActiveShards(ActiveShardCount waitForActiveShards)");
        return this;
    }
    ...
    public ClusterHealthRequestBuilder setWaitForActiveShards(int waitForActiveShards) {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthRequestBuilder_setWaitForActiveShards(int waitForActiveShards)");
        request.waitForActiveShards(waitForActiveShards);
        return this;
    }
    ...
    public ClusterHealthRequestBuilder setWaitForNodes(String waitForNodes) {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthRequestBuilder_setWaitForNodes(String waitForNodes)");
        request.waitForNodes(waitForNodes);
        return this;
    }

    public ClusterHealthRequestBuilder setWaitForEvents(Priority waitForEvents) {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthRequestBuilder_setWaitForEvents(Priority waitForEvents)");
