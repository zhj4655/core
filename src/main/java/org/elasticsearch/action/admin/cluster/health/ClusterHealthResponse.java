...
public class ClusterHealthResponse extends ActionResponse implements StatusToXContentObject {
    ...
    public ClusterHealthResponse(String clusterName, String[] concreteIndices, ClusterState clusterState) {
        ...
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_ClusterHealthResponse(String clusterName, String[] concreteIndices, ClusterState clusterState)");
    }
    ...
    public ClusterHealthResponse(String clusterName, String[] concreteIndices, ClusterState clusterState, int numberOfPendingTasks,
        ...
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_ClusterHealthResponse(String clusterName, String[] concreteIndices, ClusterState clusterState, int numberOfPendingTasks,int numberOfInFlightFetch, int delayedUnassignedShards, TimeValue taskMaxWaitingTime)");
    }

    public String getClusterName() {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_getClusterName() ");
        return clusterName;
    }

    //package private for testing
    ClusterStateHealth getClusterStateHealth() {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_getClusterStateHealth()");
        return clusterStateHealth;
    }

    public int getActiveShards() {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_getActiveShards())");
        return clusterStateHealth.getActiveShards();
    }

    public int getRelocatingShards() {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_getRelocatingShards() ");
        return clusterStateHealth.getRelocatingShards();
    }

    public int getActivePrimaryShards() {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_getActivePrimaryShards()");
        return clusterStateHealth.getActivePrimaryShards();
    }

    public int getInitializingShards() {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_getInitializingShards()");
        return clusterStateHealth.getInitializingShards();
    }

    public int getUnassignedShards() {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_getUnassignedShards() ");
        return clusterStateHealth.getUnassignedShards();
    }

    public int getNumberOfNodes() {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_getNumberOfNodes()");
        return clusterStateHealth.getNumberOfNodes();
    }

    public int getNumberOfDataNodes() {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_getNumberOfDataNodes()");
        return clusterStateHealth.getNumberOfDataNodes();
    }

    public int getNumberOfPendingTasks() {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_getNumberOfPendingTasks()");
        return this.numberOfPendingTasks;
    }

    public int getNumberOfInFlightFetch() {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_getNumberOfInFlightFetch()");
    ...
    public int getDelayedUnassignedShards() {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_setWaitForEvents(Priority waitForEvents)");
    ...
    public boolean isTimedOut() {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_isTimedOut()");
        return this.timedOut;
    }

    public void setTimedOut(boolean timedOut) {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_setTimedOut(boolean timedOut)");
        this.timedOut = timedOut;
    }

    public ClusterHealthStatus getStatus() {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_getStatus()");
    ...
    public void setStatus(ClusterHealthStatus status) {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_setStatus(ClusterHealthStatus status)");
        if (status == null) {
    ...
    public Map<String, ClusterIndexHealth> getIndices() {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_getIndices()");
    ...
    public TimeValue getTaskMaxWaitingTime() {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_getTaskMaxWaitingTime()");
    ...
    public double getActiveShardsPercent() {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_getActiveShardsPercent()");
    ...
    public static ClusterHealthResponse readResponseFrom(StreamInput in) throws IOException {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_readResponseFrom(StreamInput in)");
    ...
    public void readFrom(StreamInput in) throws IOException {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_readFrom(StreamInput in)");
        super.readFrom(in);
    ...
    public void writeTo(StreamOutput out) throws IOException {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_writeTo(StreamOutput out)");
        super.writeTo(out);
    ...
    public RestStatus status() {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_status()");
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        System.out.println("org.elasticsearch.action.admin.cluster.health_ClusterHealthResponse_toXContent(XContentBuilder builder, Params params)");
        builder.startObject();
