...
public class AggregationBuilders {
    ...
    public static DateHistogramAggregationBuilder dateHistogram(String name) {
        System.out.println("org.elasticsearch.search.aggregations_AggregationBuilder_dateHistogram(String name)__用一个给定的名字创建一个DateHistogramAggregationBuilder，名字为：" +name);
