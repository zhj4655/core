...
public class AggregatorFactories {
    ...
    private static AggregatorFactories.Builder parseAggregators(QueryParseContext parseContext, int level) throws IOException {
      System.out.println("djfkjkljkd5999999999999999999999999999999999999999999999999999999999999");
        System.out.println("org.elasticsearch.search.aggregations_AggragatorFactories.parseAggregators(QueryParseContext parseContext, int level) 解析aggragations请求");
        ...
        while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
            ...
            while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
                ...
                if (token == XContentParser.Token.START_OBJECT) {
                    ...
                    case "aggs":
                        ...
                        System.out.println("case:aggs/aggregations");
            ...
            if (aggBuilder == null) {
                ...
                if (subFactories != null) {
                    System.out.println("subFactories != null");
                    aggBuilder.subAggregations(subFactories);
                }

                if (aggBuilder instanceof AggregationBuilder) {
                    System.out.println("aggBuilder instanceof AggregationBuilder");
