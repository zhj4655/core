...
public final class InternalDateHistogram extends InternalMultiBucketAggregation<InternalDateHistogram, InternalDateHistogram.Bucket>
    ...
    public static class Bucket extends InternalMultiBucketAggregation.InternalBucket implements Histogram.Bucket {
        ...
        public Bucket(long key, long docCount, boolean keyed, DocValueFormat format,
            ...
            System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_InternalDateHistogram_Bucket(long key, long docCount, boolean keyed, DocValueFormat format,InternalAggregations aggregations) ");
        }
        ...
        public Bucket(StreamInput in, boolean keyed, DocValueFormat format) throws IOException {
            ...
            System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_InternalDateHistogram_Bucket(StreamInput in, boolean keyed, DocValueFormat format)");
        ...
        public void writeTo(StreamOutput out) throws IOException {
            ...
            System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_InternalDateHistogram_writeTo(StreamOutput out)");
            
        }

        @Override
        public String getKeyAsString() {
            System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_InternalDateHistogram_getKeyAsString()");
        ...
        Bucket reduce(List<Bucket> buckets, ReduceContext context) {
            System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_InternalDateHistogram_ reduce(List<Bucket> buckets, ReduceContext context) ");
        ...
        public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
            System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_InternalDateHistogram_ toXContent(XContentBuilder builder, Params params)");
    ...
    public InternalDateHistogram(StreamInput in) throws IOException {
        ...
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_InternalDateHistogram_ InternalDateHistogram(StreamInput in)");
    ...
    protected void doWriteTo(StreamOutput out) throws IOException {
        ...
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_InternalDateHistogram_ doWriteTo(StreamOutput out)");
           
    }

    @Override
    public String getWriteableName() {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_InternalDateHistogram_getWriteableName()");
    ...
    public List<InternalDateHistogram.Bucket> getBuckets() {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_InternalDateHistogram_getBuckets()");
    ...
    public InternalDateHistogram create(List<Bucket> buckets) {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_InternalDateHistogram_ create(List<Bucket> buckets)");
    ...
    public Bucket createBucket(InternalAggregations aggregations, Bucket prototype) {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_InternalDateHistogram_createBucket(InternalAggregations aggregations, Bucket prototype)");
    ...
    private List<Bucket> reduceBuckets(List<InternalAggregation> aggregations, ReduceContext reduceContext) {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_InternalDateHistogram_reduceBuckets(List<InternalAggregation> aggregations, ReduceContext reduceContext)");
    ...
    private void addEmptyBuckets(List<Bucket> list, ReduceContext reduceContext) {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_InternalDateHistogram_addEmptyBuckets(List<Bucket> list, ReduceContext reduceContext)");
    ...
    public InternalAggregation doReduce(List<InternalAggregation> aggregations, ReduceContext reduceContext) {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_InternalDateHistogram_ doReduce(List<InternalAggregation> aggregations, ReduceContext reduceContext) ");
    ...
    public XContentBuilder doXContentBody(XContentBuilder builder, Params params) throws IOException {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_InternalDateHistogram_doXContentBody(XContentBuilder builder, Params params)");
    ...
    public InternalAggregation createAggregation(List<MultiBucketsAggregation.Bucket> buckets) {
        ...
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_InternalDateHistogram_createAggregation(List<MultiBucketsAggregation.Bucket> buckets)");
    ...
    public Bucket createBucket(Number key, long docCount, InternalAggregations aggregations) {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_InternalDateHistogram_createBucket(Number key, long docCount, InternalAggregations aggregations)");
