...
public final class DateHistogramAggregatorFactory
    ...
    protected Aggregator doCreateInternal(ValuesSource.Numeric valuesSource, Aggregator parent, boolean collectsFromSingleBucket,
       ...
       System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_DataHistogramAggregationFactory_Aggregator doCreateInternal(ValuesSource.Numeric valuesSource, Aggregator parent, boolean collectsFromSingleBucket, List<PipelineAggregator> pipelineAggregators, Map<String, Object> metaData)");
    ...
    private Aggregator createAggregator(ValuesSource.Numeric valuesSource, Aggregator parent, List<PipelineAggregator> pipelineAggregators,
        ...
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_DataHistogramAggregationFactory_createAggregator(ValuesSource.Numeric valuesSource, Aggregator parent, List<PipelineAggregator> pipelineAggregators, Map<String, Object> metaData) ");
    ...
    protected Aggregator createUnmapped(Aggregator parent, List<PipelineAggregator> pipelineAggregators, Map<String, Object> metaData)
            throws IOException {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_DataHistogramAggregationFactory_createUnmapped(Aggregator parent, List<PipelineAggregator> pipelineAggregators, Map<String, Object> metaData)");
