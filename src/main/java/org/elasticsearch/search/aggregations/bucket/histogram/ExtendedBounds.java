...
public class ExtendedBounds implements ToXContent, Writeable {
    ...
    public ExtendedBounds(Long min, Long max) {
        ...
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_ExtendedBounds_ExtendedBounds(Long min, Long max)");
    }
    ...
    public ExtendedBounds(String minAsStr, String maxAsStr) {
        ...
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_ExtendedBounds_ExtendedBounds(String minAsStr, String maxAsStr)");
    }
    ...
    private ExtendedBounds(Long min, Long max, String minAsStr, String maxAsStr) {
        ...
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_ExtendedBounds_ExtendedBounds(Long min, Long max, String minAsStr, String maxAsStr)");
    }
    ...
    public ExtendedBounds(StreamInput in) throws IOException {
        ...
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_ExtendedBounds_ExtendedBounds(StreamInput in)");
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_ExtendedBounds_writeTo(StreamOutput out)");
    ...
    ExtendedBounds parseAndValidate(String aggName, SearchContext context, DocValueFormat format) {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_parseAndValidate(String aggName, SearchContext context, DocValueFormat format)");
    ...
    ExtendedBounds round(Rounding rounding) {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_round(Rounding rounding)");
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_toXContent(XContentBuilder builder, Params params)");
