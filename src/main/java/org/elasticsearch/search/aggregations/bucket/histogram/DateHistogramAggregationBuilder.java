...
public class DateHistogramAggregationBuilder
    ...
    public DateHistogramAggregationBuilder(String name) {
        ...
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_DataHistogramAggregationBuilder_DateHistogramAggregationBuilder(String name)__用一个给定的名字创建一个新的builder,名字为:"+name);
    }
    ...
    public DateHistogramAggregationBuilder(StreamInput in) throws IOException {
        ...
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_DataHistogramAggregationBuilder_DateHistogramAggregationBuilder(StreamInput in)__读取流数据，用.作为间隔");
        System.out.println("keyed="+keyed);
        System.out.println("minDocCount="+minDocCount);
    ...
    protected void innerWriteTo(StreamOutput out) throws IOException {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_DataHistogramAggregationBuilder_innerWriteTo(StreamOutput out)");
    ...
    public double interval() {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_DataHistogramAggregationBuilder_interval()_以毫秒的形式获取当前间隔");
        return interval;
    }
    ...
    public DateHistogramAggregationBuilder interval(long interval) {
        ...
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_DateHistogramAggregationBuilder interval(long interval)__设置时间间隔，如果interval()函数和这个函数都设置了时间间隔，以这个为准");
        return this;
    }
    ...
    public DateHistogramAggregationBuilder dateHistogramInterval(DateHistogramInterval dateHistogramInterval) {
        ...
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_DateHistogramAggregationBuilder_dateHistogramInterval(DateHistogramInterval dateHistogramInterval)_初始化histogram分组的时间间隔");
        return this;
    }
    ...
    public DateHistogramAggregationBuilder offset(String offset) {
        ...
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_DateHistogramAggregationBuilder_DateHistogramAggregationBuilder offset(String offset)");
    ...
    public DateHistogramAggregationBuilder extendedBounds(ExtendedBounds extendedBounds) {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_DateHistogramAggregationBuilder_extendedBounds(ExtendedBounds extendedBounds)");
    ...
    public Histogram.Order order() {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_DateHistogramAggregationBuilder_order()");
        return order;
    }
    ...
    public DateHistogramAggregationBuilder order(Histogram.Order order) {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_DateHistogramAggregationBuilder_order(Histogram.Order order)");
        if (order == null) {
    ...
    protected XContentBuilder doXContentBody(XContentBuilder builder, Params params) throws IOException {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_DateHistogramAggregationBuilder_doXContentBody(XContentBuilder builder, Params params)");
        if (dateHistogramInterval == null) {
    ...
    protected ValuesSourceAggregatorFactory<Numeric, ?> innerBuild(SearchContext context, ValuesSourceConfig<Numeric> config,
        ...
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_DateHistogramAggregationBuilder_innerBuild(SearchContext context, ValuesSourceConfig<Numeric> config, AggregatorFactory<?> parent, Builder subFactoriesBuilder)");
    ...
    private Rounding createRounding() {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_DateHistogramAggregationBuilder_createRounding()");
    ...
    private static InternalOrder parseOrder(XContentParser parser, QueryParseContext context) throws IOException {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_DateHistogramAggregationBuilder_parseOrder(XContentParser parser, QueryParseContext context)");
