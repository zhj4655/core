...
class DateHistogramAggregator extends BucketsAggregator {
    ...
    public boolean needsScores() {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_DateHistogramAggregator_needsScores()");
    ...
    public LeafBucketCollector getLeafCollector(LeafReaderContext ctx,
        ...
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_DateHistogramAggregator_getLeafCollector(LeafReaderContext ctx, final LeafBucketCollector sub)");
    ...
    public InternalAggregation buildAggregation(long owningBucketOrdinal) throws IOException {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_DateHistogramAggregator_buildAggregation(long owningBucketOrdinal)");
    ...
    public InternalAggregation buildEmptyAggregation() {
        System.out.println("org.elasticsearch.search.aggregations.bucket.histogram_DateHistogramAggregator_buildEmptyAggregation()");
        InternalDateHistogram.EmptyBucketInfo emptyBucketInfo = minDocCount == 0
                ? new InternalDateHistogram.EmptyBucketInfo(rounding, buildEmptySubAggregations(), extendedBounds)
                : null;
