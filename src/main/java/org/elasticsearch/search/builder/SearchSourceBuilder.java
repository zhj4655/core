...
public final class SearchSourceBuilder extends ToXContentToBytes implements Writeable {
    ...
    public void parseXContent(QueryParseContext context) throws IOException {
        System.out.println("org.elasticsearch.search.builder_SearchSourceBuilder_parseXContent(QueryParseContext context)");
        ...
        while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
            ...
            if (token == XContentParser.Token.FIELD_NAME) {
                ...
                if (FROM_FIELD.match(currentFieldName)) {
                    ...
                    System.out.println("terminateAfter="+terminateAfter);
                    ...
                    System.out.println("storedFieldsContext="+storedFieldsContext);
                ...
                if (QUERY_FIELD.match(currentFieldName)) {
                    ...
                    System.out.println("postQueryBuilder="+postQueryBuilder);
                } else if (_SOURCE_FIELD.match(currentFieldName)) {
                    fetchSourceContext = FetchSourceContext.fromXContent(context.parser());
                    System.out.println("fetchSourceContext="+fetchSourceContext);
                    ...
                    System.out.println("scriptFields="+scriptFields);
                    ...
                    System.out.println("AGGREGATIONS_FIELD.match(currentFieldName)|| AGGS_FIELD.match(currentFieldName)");
                    ...
                    System.out.println("suggestBuilder="+suggestBuilder);
                } else if (SORT_FIELD.match(currentFieldName)) {
                    ...
                    System.out.println("rescoreBuilders="+rescoreBuilders);
                    ...
                    while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
                        if (token == XContentParser.Token.FIELD_NAME) {
                            ...
                            System.out.println("extSectionName="+extSectionName);
                        } else {
                    ...
                    System.out.println("sliceBuilder="+sliceBuilder);
                ...
                if (STORED_FIELDS_FIELD.match(currentFieldName)) {
                    ...
                    System.out.println("searchAfterBuilder="+searchAfterBuilder);
                } else if (FIELDS_FIELD.match(currentFieldName)) {
